    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card z-card p-2 mt-2 shadow border-0">
                ...
                <h6 class="card-title p-2 text-center mt-2" style="color: #654A6C; font-size: 27px;"> دسته بندی تصاویر </h6>

                <div class="card-body border-0">
                    <button class="btn btn-primary rounded" style="background-color: #1784D9; font-size: 13px;"><a
                            href="add_cat.php" class="text-white"> افزودن  </a></button>
                    <hr>
            ...
            <a class="btn btn-success rounded" style="font-size: 12px; color: #fff;"
               href="edit_cat.php?id=<?php echo $id ?>">
                <i class="fa fa-edit align-middle" style="font-size: 14px !important;"> </i> ویرایش </a>
            </td>
            <td>
                <a class="btn btn-danger rounded" style="font-size: 12px;" href="delete_cat.php?id=<?php echo $id ?>"
                   onclick="delet()">
