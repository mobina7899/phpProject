...
if (isset($_POST['submit'])) {
    ...
    $new_whatsApp = $_POST["whatsApp"];
    $new_telegram = $_POST["telegram"];
    $new_insta = $_POST["insta"];
...
//
    ...
    $run_update = $contact->updatedata($id,$new_email, $new_mobile, $new_whatsApp, $new_telegram, $new_insta, $new_address, $new_lat, $new_lon);
...
<div class="container" style="margin-top: 100px; background-color: #EDEDED">
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="row table-bordered border-dark">
            ...
            <div class="col-lg-8 p-2 text-center">
                <input type="text" name="whatsApp" value="<?php echo $whatsApp; ?>" class="form-control">
            </div>
        </div>
        ...
        <div class="row table-bordered border-dark">
            ...
            <div class="col-lg-8 p-2 text-center">
                <input type="text" name="telegram" value="<?php echo $telegram; ?>" class="form-control">
            </div>
        </div>
        <div class="row table-bordered border-dark">
            <div class="col-lg-4 p-2 text-center border-left border-dark">
            ...
            <div class="col-lg-8 p-2 text-center">
                <input type="text" name="insta" value="<?php echo $insta; ?>" class="form-control" >
            </div>
        </div>
        ...
        <div class="row table-bordered border-dark">
            ...
            <div class="col-lg-8 p-2 text-center">
                <input type="text" name="lat" value="<?php echo $lat; ?>" class="form-control" >
            </div>
        </div>
        ...
        <div class="row table-bordered border-dark">
            ...
            <div class="col-lg-8 p-2 text-center">
                <input type="text" name="lon" value="<?php echo $lon; ?>" class="form-control" >
            </div>
        </div>
