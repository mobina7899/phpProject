    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card z-card p-2 mt-2 shadow border-0">
                ...
                <h6 class="card-title p-2 text-center mt-2" style="color: #654A6C; font-size: 27px;"> اخبار </h6>

                <div class="card-body border-0">
                    <button class="btn btn-primary rounded" style="background-color: #1784D9; font-size: 13px;"><a
                                href="addNews.php" class="text-white"> افزودن خبر </a></button>
                    <hr>
                    <table class="table table-bordered table-responsive-lg">
                        ...
                        <tr class="roww">
                            ...
                            <td align="center"><a href="detail_news.php?id=<?php echo $id ?>"> <?php echo $title ?> </a>
                            </td>
            ...
            <a class="btn btn-success rounded" style="font-size: 12px; color: #fff;"
               href="edit_news.php?id=<?php echo $id ?>">
                <i class="fa fa-edit align-middle" style="font-size: 14px !important;"> </i> ویرایش </a>
            </td>
            <td>
                <a class="btn btn-danger rounded" style="font-size: 12px;" href="delete_news.php?id=<?php echo $id ?>"
                   onclick="delet()">
