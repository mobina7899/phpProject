...
if (isset($_POST['submit'])) {
    ...
    $result = $slide->insertData($address_image, $url, $title, $date);

//display message to user
    if ($result) {
        echo "<script>alert('تبریک...داده های مربوط به اسلاید شما به درستی وارد شد.')</script>";
...
<div class="container" style="margin-top: 100px; background-color: #EDEDED">
    <form action="" method="post" enctype="multipart/form-data">
        <h4 class="text-center p-5"> افزودن اسلاید </h4>
