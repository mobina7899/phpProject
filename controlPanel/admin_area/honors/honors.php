    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card z-card p-2 mt-2 shadow border-0">
                ...
                <h6 class="card-title p-2 text-center mt-2" style="color: #654A6C; font-size: 27px;"> افتخارات </h6>

                <div class="card-body border-0">
                    <button class="btn btn-primary rounded" style="background-color: #1784D9; font-size: 13px;"><a
                            href="add_honor.php" class="text-white"> افزودن  </a></button>
                    <hr>
                    <table class="table table-bordered table-responsive-lg">
                        ...
                        <tr class="roww">
                            ...
                            $honors = $honor->ShowAll();

                            $i = 0;
                            $count = sizeof($honors);
                            while ($i < $count)
                            {
                            $title = $honors[$i]['title'];
                            $id = $honors[$i]['id'];
                            $i++;
                            ?>
                            <td align="center"><?php echo $i ?></td>
                            <td align="center"><a
                                    href="detail_honor.php?id=<?php echo $id ?>"> <?php echo $title ?> </a></td>

                            <td>
                </div>
            </div>
            <a class="btn btn-success rounded" style="font-size: 12px; color: #fff;"
               href="edit_honor.php?id=<?php echo $id ?>">
            ...
            <td>
                <a class="btn btn-danger rounded" style="font-size: 12px;"
                   href="delete_honor.php?id=<?php echo $id ?>"
                   onclick="delet()">
