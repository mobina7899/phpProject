...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2021 at 10:08 PM
...
CREATE TABLE `form_tamas` (
  ...
  `body` text COLLATE utf8_persian_ci NOT NULL,
  `datetime` varchar(50) COLLATE utf8_persian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_persian_ci;
...
INSERT INTO `form_tamas` (`id`, `name`, `email`, `mobail`, `body`, `datetime`) VALUES
(1, 'مونا', 'پروژه', 'yari.mona67@gmail.com', 'درخواست ایجاد پروژه', '1/7/1400'),
(2, 'sahar', 'یسب', 'sa.re45@gmail.com', 'بلذبذ', '1/5/1400'),
(3, 'ali', '03546848456', 'yari.m@chmail.ir', 'vcx', '1/5/1400');
